...
[[resources-retailer-stores-list]]
=== Listing retailerStores

A `GET` request will list all of the service's retailerStores.

operation::/retailer-stores-tests/retailer-stores-list-example[snippets='auto-response-fields,curl-request,http-response,links']



[[resources-retailer-stores-create]]
=== Creating a retailerStore

A `POST` request is used to create a retailerStore.

operation::/retailer-stores-tests/create-retailer-store[snippets='auto-request-fields,curl-request,http-response']
...
include::{snippets}/retailer-stores-tests/retailer-store-get-example/links.adoc[]
...
operation::/retailer-stores-tests/retailer-store-get-example[snippets='auto-response-fields,curl-request,http-response']
...
include::{snippets}/retailer-stores-tests/retailer-store-update-example/auto-request-fields.adoc[]

To leave an attribute of a note unchanged, any of the above may be omitted from the request.

==== Example request

include::{snippets}/retailer-stores-tests/retailer-store-update-example/curl-request.adoc[]

==== Example response

include::{snippets}/retailer-stores-tests/retailer-store-update-example/http-response.adoc[]
...
operation::cities-list-example[snippets='auto-response-fields,curl-request,http-response,links']
...
operation::cities-get-example[snippets='auto-response-fields,curl-request,http-response']
...
operation::reits-list-example[snippets='auto-response-fields,curl-request,http-response,links']
...
operation::reits-get-example[snippets='auto-response-fields,curl-request,http-response']
...
operation::states-list-example[snippets='auto-response-fields,curl-request,http-response,links']
...
operation::states-get-example[snippets='auto-response-fields,curl-request,http-response']
...
operation::tickers-list-example[snippets='auto-response-fields,curl-request,http-response,links']
...
operation::tickers-get-example[snippets='auto-response-fields,curl-request,http-response']
