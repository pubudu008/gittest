...
import com.example.myproject.demo.services.topicServices;
...
public topic getOneTopic(@PathVariable String id) {
	...
	public void patchUpdate(@RequestBody topic tp,@PathVariable String id) {
		topicServices.patchUpdatetopic(tp,id);
